...
You can also modify the window control buttons, outline, and padding with this plugin: [siyuan_main_window_modification](https://github.com/zxkmm/siyuan_main_window_modification)
